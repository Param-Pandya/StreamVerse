...
const moviesDatabase: Movie[] = [
  ...
  },
  {
    ...
    poster: 'aiw',
    backdrop: 'slideAvengersInfinityWar',
    overview:
    ...
    rating: 4.9,
    category: 'Marvel',
    youtubeTrailerId: 'QwievZ1Tx-8'
  },
  {
    id: 'anhe4',
    title: 'Star Wars: A New Hope',
    poster: 'anhe4',
    backdrop: 'slideStarWarsANewHope',
    overview:
    ...
    rating: 4.9,
    category: 'Star Wars',
    youtubeTrailerId: '1g3_CFmnU7k'
  },
  {
    id: 'aotce2',
    title: 'Star Wars: Attack of the Clones',
    poster: 'aotce2',
    backdrop: 'slideStarWarsAttackOfTheClones',
    overview:
    ...
    rating: 4.5,
    category: 'Star Wars',
    youtubeTrailerId: 'gYbW1F_c9eM'
  },
  {
    id: 'batb',
    title: 'Beauty and the Beast',
    poster: 'batb',
    backdrop: 'slideBeautyAndTheBeast',
    overview:
  ...
  },
  {
    ...
    poster: 'cacw',
    backdrop: 'slideCaptainAmericaCivilWar',
    overview:
  ...
  },
  {
    ...
    rating: 4.3,
    category: 'Star Wars',
    youtubeTrailerId: 'jPEYpryMp2s'
  },
  {
    id: 'tesbe5',
    title: 'Star Wars: The Empire Strikes Back',
    poster: 'tesbe5',
    backdrop: 'slideStarWarsTheEmpireStrikesBack',
    overview:
  ...
  },
  {
    ...
    poster: 'tfae7',
    backdrop: 'slideStarWarsTheForceAwakens',
    overview:
    ...
    rating: 4.7,
    category: 'Star Wars',
    youtubeTrailerId: 'sGbxmsDFVnE'
  },
  {
    id: 'tpme1',
    title: 'Star Wars: The Phantom Menace',
    poster: 'tpme1',
    backdrop: 'slideStarWarsThePhantomMenace',
    overview:
  ...
  },
  {
    ...
    rating: 4.8,
    category: 'Marvel',
    youtubeTrailerId: '8ugaeA-nMTc'
  },
  {
    id: 'b',
    title: 'Black Panther',
    poster: 'b',
    backdrop: 'slideBlackPanther',
    overview:
  ...
  },
  {
    ...
    poster: 'p',
    backdrop: 'slideSpiderManHomecoming',
    overview:
  ...
  },
  {
    ...
    poster: 'slideFantasy',
    backdrop: 'slideWhispersOfTheForest',
    overview:
  ...
  },
  {
    ...
    poster: 'tlm',
    backdrop: 'slideTheLittleMermaid',
    overview:
    ...
    rating: 4.6,
    category: 'Movies',
    youtubeTrailerId: '0-wPm99PF9U'
  },
  {
    id: 'f',
    title: 'Finding Dory',
    poster: 'f',
    backdrop: 'slideFindingDory',
    overview:
  ...
  },
  {
    ...
    poster: 'thond',
    backdrop: 'slideTheHunchbackOfNotreDame',
    overview:
  ...
  },
  {
    ...
    poster: 'tsits',
    backdrop: 'slideTheSwordInTheStone',
    overview:
  ...
  },
  {
    ...
    rating: 4.4,
    category: 'DC',
    youtubeTrailerId: 'r9-DM9uBtVI'
  },
  {
    id: 'about_developer',
    title: 'About the Developer',
    poster: 'developerPoster',
    backdrop: 'developerPoster',
    overview:
      'A short portfolio introduction video by Param Pandya explaining the project and architecture of the StreamVerse application, built with Expo SDK 54, React Native, and custom services.',
    genres: ['Developer', 'Project', 'Portfolio'],
    runtime: '2m',
    releaseYear: '2026',
    rating: 5.0,
    category: 'Movies',
  ...
  },
  {
    ...
    backdrop: 'rajneeti',
    overview:
      'A young man who has lived abroad returns to India and gets sucked into the dirty, dramatic world of dynastic politics after the assassination of a political figure.',
    genres: ['Drama', 'Thriller'],
    runtime: '143m',
    releaseYear: '2010',
    rating: 4.5,
    category: 'Movies',
    youtubeTrailerId: '9xr726ipSZ4'
  },
  {
    id: 'satyagraha',
    title: 'Satyagraha',
    ...
    backdrop: 'satyagraha',
    overview:
      'A father seeks justice for the death of his son, sparking a massive peaceful public movement against a corrupt political establishment.',
    genres: ['Drama', 'Thriller'],
    runtime: '152m',
    releaseYear: '2013',
    rating: 4.3,
    category: 'Movies',
    youtubeTrailerId: '42GooWJOe9E'
  },
  {
    id: 'tees_maar_khan',
    title: 'Tees Maar Khan',
    poster: 'teesmaarkhan',
    backdrop: 'teesmaarkhan',
    overview:
      'A smart, flamboyant con artist and thief plans a massive train robbery while posing as a famous filmmaker shooting a movie on location.',
    genres: ['Action', 'Comedy'],
    runtime: '135m',
    releaseYear: '2010',
    rating: 4.0,
    category: 'Movies',
    youtubeTrailerId: '8ucYhlbg0Ko'
  },
  {
    id: 'go_goa_gone',
    title: 'Go Goa Gone',
    ...
    backdrop: 'gogoagone',
    overview:
      'A group of friends visiting Goa get trapped on a remote island when a new party drug turns the partygoers into flesh-eating zombies.',
    genres: ['Action', 'Comedy', 'Horror'],
    runtime: '111m',
    releaseYear: '2013',
    rating: 4.6,
    category: 'Movies',
    youtubeTrailerId: 'RBQamFajUSU'
  },
  {
    id: 'dil_toh_bachcha_hai_ji',
    title: 'Dil Toh Bachcha Hai Ji',
    poster: 'diltohbachchahaiji',
    backdrop: 'diltohbachchahaiji',
    overview:
      'Three men sharing an apartment navigate their romantic lives and face various lighthearted challenges while falling in love with different women.',
    genres: ['Comedy', 'Romance', 'Drama'],
    runtime: '135m',
    releaseYear: '2011',
    rating: 4.1,
    category: 'Movies',
    youtubeTrailerId: '4JtA4oVSfUA'
  }
];
